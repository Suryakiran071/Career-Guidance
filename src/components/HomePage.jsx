  ...
  return (
    <div className="min-h-screen">
      ...
      <Link
        ...
        className="fixed bottom-4 right-4 bg-green-600 text-white px-6 py-3 rounded-full shadow-lg hover:bg-green-700 transition duration-300 z-10"
      >
        Chat Now
      </Link>
      ...
      <div className="relative w-full h-[60vh]">
        ...
        <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 text-center text-white">
          ...
          <Link
            to="/career-guidance"
            className="bg-green-600 mt-5 text-white px-6 py-3 rounded-full hover:bg-green-700 transition duration-300"
          >
            Get Started
          </Link>
        </div>
      ...
      <div className="bg-white py-20 px-5">
        <h2 className="text-4xl font-semibold text-center text-green-500 mb-6">What We Do</h2>
      ...
      <div className="py-20 px-5 bg-gray-800">
        <h2 className="text-4xl font-semibold text-center text-green-500 mb-8">Features & Benefits</h2>
        <div className="flex flex-col md:flex-row justify-center items-center gap-12">
          <div className="text-center text-white">
            <div className="text-3xl font-semibold mb-4 text-green-600">Personalized Recommendations</div>
            <p className="text-gray-300">
              Get career suggestions based on your unique skills, interests, and academic background.
            </p>
          </div>
          <div className="text-center text-white">
            <div className="text-3xl font-semibold mb-4 text-green-600">AI-Powered Insights</div>
            <p className="text-gray-300">
              Use advanced AI algorithms to analyze your data and get actionable insights tailored to your future.
            </p>
          </div>
          <div className="text-center text-white">
            <div className="text-3xl font-semibold mb-4 text-green-600">Career Exploration Tools</div>
            <p className="text-gray-300">
      ...
      <div className="bg-gray-100 py-20 px-5">
        <h2 className="text-4xl font-semibold text-center text-green-500 mb-8">What Our Users Say</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            ...
            <p className="font-semibold text-green-600">John Doe</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            ...
            <p className="font-semibold text-green-600">Jane Smith</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            ...
            <p className="font-semibold text-green-600">Mark Johnson</p>
